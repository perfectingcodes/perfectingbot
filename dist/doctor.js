...
if (!config.discovery.enabled)
    ...
    if (perDay > budget)
        warn(`${line} — discovery will pause partway through each day. Widen DISCOVERY_INTERVAL_SEC or lower DISCOVERY_PER_CYCLE.`);
    else
        ok(line);
    const plans = [["Starter", 10_000], ["Growth", 50_000], ["Scale", 200_000]];
